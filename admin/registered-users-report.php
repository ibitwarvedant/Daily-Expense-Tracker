...
?>
              ...
              <td><?php  echo $row['FullName'];?></td>
                  ...
                  <td><a href="edit-users.php?editid=<?php echo $row['ID'];?>" target="_blank">Edit</a> |<a href="manage-expense.php?delid=<?php echo $row['ID'];?>" onClick="return confirm('Are you sure?')" style="text-decoration:none;font-size:16px;color:rgba(255,0,4,1.00);">Delete</a> | <a href="user-expense-details.php?uid=<?php echo $row['ID'];?>&&name=<?php echo $row['FullName'];?>" target="_blank">Expense Details</a>
                </tr>
                <?php 
$cnt=$cnt+1;
} } else{?>
